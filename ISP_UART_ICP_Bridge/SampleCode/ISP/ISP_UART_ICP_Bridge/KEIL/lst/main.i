...
void SYS_Init(void)
{
    ...
    ((CLK_T *) (((uint32_t)0x40000000) + 0x00200UL))->CLKSEL1 &= ~(0x3ul << (24));
    ((CLK_T *) (((uint32_t)0x40000000) + 0x00200UL))->CLKSEL1 |= (0x3UL << (24));
    ...
    ((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->GPH_MFPH |= ((0x0AUL<<(4)) | (0x0AUL<<(0)));
}
...
_APROM:
    ((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->RSTSTS = ((0x1ul << (0)) | (0x1ul << (1)));
    ((FMC_T *) (((uint32_t)0x40000000) + 0x0C000UL))->ISPCTL &= ~((0x1ul << (0)) | (0x1ul << (1)));
